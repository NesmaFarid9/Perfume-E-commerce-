  ...
  return (
    <article className="flex min-w-0 flex-1 flex-col items-start gap-4 self-stretch rounded-lg bg-white p-4">
      ...
      <div className="flex w-full flex-col items-start gap-3">
        ...
        <button
          type="button"
          className="flex w-full items-center justify-center rounded border border-solid border-[#ebe6de] py-3 text-[11px] font-semibold uppercase whitespace-nowrap text-[#1a1a1a] hover:cursor-pointer hover:bg-[#f4f0eb] transition-colors hover:cursor-pointer"
          onClick={() =>
            addItem({
